    ...
    <div className="card-container">
      ...
      {data && loading ? (
        ...
        <div className="card-body">
          ...
          <p>
            <i className="fa-solid fa-cloud"></i>Weather Description:{" "}
          ...
          <p>
            {" "}
            <i className="fa-solid fa-temperature-high"></i> Maximum
            temperature: {(parseFloat(data.main.temp_max) - 273.15).toFixed(1)}
            &deg;C
          </p>
          <p>
            <i className="fa-solid fa-snowflake"></i> Humidity:{" "}
            {data.main.humidity} %
          </p>
          <p>
            <i className="fa-solid fa-star"></i> Atmopheric pressure:{" "}
            {data.main.pressure} hPa
          </p>
          <p>
            <i className="fa-solid fa-water"></i> Sea Level pressure:{" "}
            {data.main.sea_level} hPa
          </p>
          <p>
            <i className="fa-solid fa-globe"> </i> Ground Level pressure:{" "}
